...
public class Savings extends JFrame {
    ...
    public String custno, custname, cdep, nyears, savtype;
    public Savings() {
        initComponents();
    }
    ...
    private void table1MouseClicked(MouseEvent e) {
        ...
        String sav = df.getValueAt(index1,4).toString();
        txtcustsaving.setSelectedItem(sav);
        double kov;
        if (sav.equals("Savings-Deluxe")) {
            Deluxe d = new Deluxe();
            kov = d.netSales();
        } else {
            Java j = new Java();
        ...
        mainLayout2(Integer.parseInt(df.getValueAt(index1,3).toString()), Double.parseDouble(df.getValueAt(index1,2).toString()),kov);
    }
    ...
    private void initComponents() {
        ...
        //======== scrollPane2 ========
        {
         ...
         contentPane.add(scrollPane2, "cell 0 11,height 100:100:100");
        ...
        contentPane.add(scrollPane3, "cell 6 11,height 100:100:100");
    ...
    public void mainLayout2(int year, double amount, double kov) {
        String[] cols = {"Year", "Starting", "Interest","Ending"};

        // initializing 2-d array with 201 rows
        String[][] data = new String[year][200];
        for (int i = 0; i < year; i++) {
            data[i][0] = ""+ (i+1);
            data[i][1] = ""+(amount+(i*(1-kov)));
            data[i][2] = ""+(1-kov)*100;
        }
        // String[][] data = {{"d1", "d4.1"},{"d2", "d2.1"},{"d3","d3.1"},{"d4", "d4.1"},{"d5","d5.1"}};
        DefaultTableModel model = new DefaultTableModel(data, cols);
